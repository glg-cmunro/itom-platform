# Step by Step - Deploy ITOM Cluster capability - CMS Containerized - 25.4
...
```
mkdir -p /opt/glg/ot/cms/25.4
cd /opt/glg/ot/cms
```

2. Download / Extract CMS helm chart package  
```
curl -kLs https://owncloud.gitops.com/index.php/s/ipLquypHVdCsaii/download -o /opt/glg/ot/cms/CMS_Helm_Chart-25.4.zip
