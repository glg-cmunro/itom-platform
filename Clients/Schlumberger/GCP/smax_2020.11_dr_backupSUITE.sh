...
##SLB GKE Prod
SRC_NFS_HOST='10.12.81.138'
SRC_NFS_GLOBAL_VOL='/gcp6133_p_nfs01/var/vols/itom/itsma/global-volume'

##SLB GKE Non-Prod
#SRC_NFS_HOST='10.145.240.146'
#SRC_NFS_GLOBAL_VOL='/gcp6133_np_nfs04/var/vols/itom/itsma/global-volume'
...
function backup_suite() {
    ...
    sudo mkdir -p /var/vols/itom/itsma/global-volume; sudo chown -R 1999:1999 /var/vols/itom/itsma/global-volume
    sudo mount -t nfs $SRC_NFS_HOST:$SRC_NFS_GLOBAL_VOL /var/vols/itom/itsma/global-volume
