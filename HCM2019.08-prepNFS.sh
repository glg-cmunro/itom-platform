...
yum list device-mapper-libs java-1.8.0-openjdk libgcrypt libseccomp libtool-ltdl net-tools nfs-utils rpcbind systemd-libs unzip conntrack-tools curl lvm2 showmount
...
mkdir -p /var/vols/itom/hcm
mkdir -p /var/vols/itom/db-backup
mkdir -p /var/vols/itom/logs
