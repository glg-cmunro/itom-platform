...
##GCP Cluster Infrastructure Build - SLB Production (NEW)
GKE_CLUSTER=gcp6133-p-k8s02
GKE_REGION=europe-west1
GKE_ZONE=europe-west1-b
#GKE_MASTER_CIDR="10.0.10.0/28"
#GKE_CLUSTER_CIDR="10.0.16.0/21"
...
## SLB GKE Prod (NEW)
PSQL_DB_HOST=10.241.160.32
NFS_SERVER=10.37.160.10
NFS_FOLDER=/gcp6133_p_nfs02
NFS_PATH_CORE=$NFS_FOLDER/var/vols/itom/core
REGISTRY_ORG=us102173-p-sis-bsys-6133
LB_EXT_IP=34.77.69.152
SUITE_VERSION=2021.02
EXT_ACCESS_FQDN=ccc.greenlightgroup.com

sudo mkdir /mnt/nfs-new
mount -t nfs $NFS_SERVER:$NFS_FOLDER /mnt/nfs-new

### Setup CDF Database
psql -h $PSQL_DB_HOST -U postgres -W #(connect to DB as user postgres)
...
sudo mkdir -p /mnt/nfs-new/var/vols/itom/itsma
sudo mkdir /mnt/nfs-new/var/vols/itom/itsma/global-volume
sudo mkdir /mnt/nfs-new/var/vols/itom/itsma/itom-logging-vol
sudo mkdir /mnt/nfs-new/var/vols/itom/itsma/db-volume
sudo mkdir /mnt/nfs-new/var/vols/itom/itsma/db-volume-1
sudo mkdir /mnt/nfs-new/var/vols/itom/itsma/db-volume-2
sudo mkdir /mnt/nfs-new/var/vols/itom/itsma/rabbitmq-infra-rabbitmq-0
sudo mkdir /mnt/nfs-new/var/vols/itom/itsma/rabbitmq-infra-rabbitmq-1
sudo mkdir /mnt/nfs-new/var/vols/itom/itsma/rabbitmq-infra-rabbitmq-2
sudo mkdir /mnt/nfs-new/var/vols/itom/itsma/smartanalytics-volume
sudo mkdir /mnt/nfs-new/var/vols/itom/itsma/itsma-smarta-saw-con-0
sudo mkdir /mnt/nfs-new/var/vols/itom/itsma/itsma-smarta-saw-con-1
sudo mkdir /mnt/nfs-new/var/vols/itom/itsma/itsma-smarta-saw-con-2
sudo mkdir /mnt/nfs-new/var/vols/itom/itsma/itsma-smarta-saw-con-3
sudo mkdir /mnt/nfs-new/var/vols/itom/itsma/itsma-smarta-saw-con-4
sudo mkdir /mnt/nfs-new/var/vols/itom/itsma/itsma-smarta-saw-con-5
sudo mkdir /mnt/nfs-new/var/vols/itom/itsma/itsma-smarta-saw-con-a-0
sudo mkdir /mnt/nfs-new/var/vols/itom/itsma/itsma-smarta-saw-con-a-1
sudo mkdir /mnt/nfs-new/var/vols/itom/itsma/itsma-smarta-saw-con-a-2
sudo mkdir /mnt/nfs-new/var/vols/itom/itsma/itsma-smarta-saw-con-a-3
sudo mkdir /mnt/nfs-new/var/vols/itom/itsma/itsma-smarta-saw-con-a-4
sudo mkdir /mnt/nfs-new/var/vols/itom/itsma/itsma-smarta-saw-con-a-5
sudo mkdir /mnt/nfs-new/var/vols/itom/itsma/itsma-smarta-sawarc-con-0
sudo mkdir /mnt/nfs-new/var/vols/itom/itsma/itsma-smarta-sawarc-con-1
sudo mkdir /mnt/nfs-new/var/vols/itom/itsma/itsma-smarta-sawarc-con-a-0
sudo mkdir /mnt/nfs-new/var/vols/itom/itsma/itsma-smarta-sawarc-con-a-1
sudo mkdir /mnt/nfs-new/var/vols/itom/itsma/itsma-smarta-sawmeta-con-0
sudo mkdir /mnt/nfs-new/var/vols/itom/itsma/itsma-smarta-sawmeta-con-1
sudo mkdir /mnt/nfs-new/var/vols/itom/itsma/itsma-smarta-sawmeta-con-a-0
sudo mkdir /mnt/nfs-new/var/vols/itom/itsma/itsma-smarta-sawmeta-con-a-1
sudo mkdir /mnt/nfs-new/var/vols/itom/itsma/db-backup-vol
sudo chown -R 1999:1999 /mnt/nfs-new/var/vols/itom/itsma

## SET Default access to NFS Directories by SUITE user
sudo setfacl -R -m u:1999:wrx /mnt/nfs-new/var/vols/itom
sudo setfacl -R -m g:1999:wrx /mnt/nfs-new/var/vols/itom
...
sudo /opt/smax/2021.02/install --nfs-server "$NFS_SERVER"  --nfs-folder "$NFS_PATH_CORE"  --registry-url "gcr.io"  --registry-username "oauth2accesstoken"  --registry-orgname "$REGISTRY_ORG"  --registry-password $(gcloud auth print-access-token) --external-access-host "$EXT_ACCESS_FQDN"  --cloud-provider gcp --loadbalancer-info "LOADBALANCERIP=$LB_EXT_IP" --db-url "jdbc:postgresql://$PSQL_DB_HOST:5432/cdfapiserverdb" --db-user "cdfapiserver" --db-password "0f5546d03a520e627f17719865aa53cd"


###For the SUITE Install the NFS Volumes will need to be similar to the following
/gcp6133_p_nfs02/var/vols/itom/itsma/global-volume
...
#### SSH Session #2
#CDF_OUTPUT_DIR=/mnt/nfs-new/var/vols/itom/core/yaml/yaml_template/output
...
#openssl req -x509 -newkey rsa:4096 -nodes -keyout Server.key -out Server.cer -days 3650 -subj "/C=US/ST=Texas/L=Sugar Land/O=Schlumberger/OU=IT/CN=ccc.greenlightgroup.com"
...
### SUITE INSTALL
SUITE_OUTPUT_DIR=/mnt/nfs-new/var/vols/itom/core/yaml/yaml_template/output
