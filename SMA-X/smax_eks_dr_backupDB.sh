...
SRC_DB_HOST='smaxdev-rds.cz4qew1aonte.us-west-2.rds.amazonaws.com'
...
function backup_db() {
    ...
    suiteDBs[cdfapiserveruserdb]='cdfapiserver;Gr33nl1ght_'
    suiteDBs[itom-cdf-idm]='cdfidm;Gr33nl1ght_'
