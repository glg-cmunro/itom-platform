...
LVM_DEVICE_DATA=/dev/mapper/centos_glg--centos7-root
LVM_DEVICE_SHARED=/dev/mapper/centos_glg--centos7-root
LVM_DEVICE_LOGS=/dev/mapper/centos_glg--centos7-root
